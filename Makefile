...
SOURCES       = mainwindow.cpp \
		...
		acbutton.cpp \
		commanager.cpp \
		alogger.cpp moc_mainwindow.cpp \
		moc_acbutton.cpp \
		moc_commanager.cpp
...
distdir: FORCE
	...
	$(COPY_FILE) --parents mainwindow.h acbutton.h commanager.h alogger.h $(DISTDIR)/
	$(COPY_FILE) --parents mainwindow.cpp main.cpp acbutton.cpp commanager.cpp alogger.cpp $(DISTDIR)/
...
moc_commanager.cpp: commanager.h
