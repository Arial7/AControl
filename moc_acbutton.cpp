...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ACButton_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ACButton_t qt_meta_stringdata_ACButton = {
    {
QT_MOC_LITERAL(0, 0, 8), // "ACButton"
QT_MOC_LITERAL(1, 9, 10), // "runCommand"
QT_MOC_LITERAL(2, 20, 0) // ""

    },
    "ACButton\0runCommand\0"
};
...
void ACButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ACButton *_t = static_cast<ACButton *>(_o);
        switch (_id) {
...
const QMetaObject ACButton::staticMetaObject = {
    { &QPushButton::staticMetaObject, qt_meta_stringdata_ACButton.data,
      qt_meta_data_ACButton,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ACButton::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ACButton.stringdata))
        return static_cast<void*>(const_cast< ACButton*>(this));
